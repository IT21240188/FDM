...
const form = () => {
    ...
    const handleChange = (e) => {
        ...
        const parsedValue = ['tenure', 'MonthlyCharges', 'TotalCharges'].includes(name)
            ? parseInt(value, 10)
            : value;
    ...
    return (
        <Container className='mt-4'>
            ...
            <Row>
                <Col>
                    <Container maxWidth="sm" style={{ margin: '0px', backgroundColor: '#e2f0f1', borderRadius: '10px', padding: '40px 20px' }}>
                        <Row className='mb-3'>
                            <Col>
                                <FormControl>
                ...
                <Col>
                    {prediction == 1 && (<>
                        <img src='/churn_customer.png' width={400} style={{ animation: 'slideIn 0.6s ease-out forwards' }} />
                    </>)}
                    {prediction == 0 && (<>
                        <img src='/happy_customer.png' width={400} style={{ animation: 'slideIn 0.6s ease-out forwards' }} />
                    </>)}
